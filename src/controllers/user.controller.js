...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    if (oldPassword === newPassword) {
        // throw new ApiError(400, "New and old password cannot be the same")
    }
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    //choose which fields to update - fullname and email
    //get details from req.body
    //check if they are empty
    //get the user fom req.user
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    //take avatarlocalpath file from req.file
    //if avatarLocalPath is empty send error
    //send avatar to cloudinary
    //if avatar is not uploaded throw error
    //get user from req.user._id and update the avatar field
    //return response
